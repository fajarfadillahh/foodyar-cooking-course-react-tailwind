  ...
  return (
    <section className="testimonial section">
      <div className="testimonial__container container grid justify-items-center gap-8">
        <h1 className="testimonial__comment text-center text-[24px] font-medium text-gray-900 xs:max-w-sm sm:max-w-md sm:text-[28px] md:max-w-lg md:text-[32px] lg:max-w-2xl lg:text-[38px] xl:max-w-4xl">
        ...
        <div className="testimonial__profile inline-flex items-center gap-4">
          ...
          <div>
            <h3 className="testimonial__name pb-1 text-[17px] font-semibold text-gray-900 md:text-[20px]">
              Camella Sarah
            </h3>
